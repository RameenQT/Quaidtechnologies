    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form class="form-horizontal" role="form" method="POST" action="{{ route('blog.index').'/'. $blog->id }}" enctype='multipart/form-data'>
                    {{ csrf_field() }}
					...
					<div class="box-body">
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder=" Title" id="title" name="title" value="{{ old('title',$blog->title) }}">
                                @if ($errors->has('title'))
                                    <span class="help-block">
					...
					<div class="box-body">
                        <div class="form-group{{ $errors->has('short_description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea id="short_description" name="short_description" rows="10" cols="80">{{ old('short_description',$blog->short_description) }}</textarea>
					...
					<div class="box-body">
                        <div class="form-group{{ $errors->has('description') ? ' has-error' : '' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea id="description" name="description" rows="10" cols="80">{{ old('description',$blog->description) }}</textarea>
					...
					<div class="box-body">
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            <label for="image" class="col-sm-2 control-label">Blog Image</label>
							<div class="col-sm-10">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
								<div class="form-group">
								  <div class="checkbox">
									<label>
									  <input type="radio" name="status" value="Active" @if($blog->status == 'Active') checked="checked" @endif >
									  Active
									</label>
								  </div>
								  ...
								  <div class="checkbox">
									<label>
									  <input type="radio" name="status" value="In Active" @if($blog->status == 'In Active') checked="checked" @endif>
									  In Active
									</label>
								  </div>
                                ...
                                <div class="box box-info box-solid">
									...
									<div class="box-body">
											...
											<div class="form-group{{ $errors->has('meta_title') ? ' has-error' : '' }}">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" placeholder=" Meta Title" id="meta_title" name="meta_title" value="{{ old('meta_title',$blog->meta_title) }}">
											...
											<div class="box-body">
												<div class="form-group{{ $errors->has('meta_description') ? ' has-error' : '' }}">
													...
													<div class="col-sm-10">
														<textarea id="meta_description" name="meta_description" rows="10" cols="113">{{ old('meta_description',$blog->meta_description) }}</textarea>
											...
											<div class="box-body">
												<div class="form-group{{ $errors->has('focus_keywords') ? ' has-error' : '' }}">
													...
													<div class="col-sm-10">
														<textarea id="focus_keywords" name="focus_keywords" rows="10" cols="113">{{ old('focus_keywords',$blog->focus_keywords) }}</textarea>
