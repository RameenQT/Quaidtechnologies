    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
				...
				<form class="form-horizontal" role="form" method="POST" action="{{ route('blog.index') }}" enctype='multipart/form-data'>
                    {{ csrf_field() }}
					...
					<div class="box-body">
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            <label for="image" class="col-sm-2 control-label">Blog Image <span class="errorstar">*</span></label>
							<div class="col-sm-10">
