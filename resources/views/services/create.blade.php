    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-info">
				...
				<form class="form-horizontal" role="form" method="POST" action="{{ route('services.index') }}" enctype='multipart/form-data'>
                    {{ csrf_field() }}
					...
					<div class="box-body">
                        <div class="form-group{{ $errors->has('image') ? ' has-error' : '' }}">
                            <label for="image" class="col-sm-2 control-label">Service Image <span class="errorstar">*</span></label>
							<div class="col-sm-10">
                                ...
                                <div class="box box-info box-solid">
									...
									<div class="box-body">
											...
											<div class="form-group{{ $errors->has('meta_title') ? ' has-error' : '' }}">
												...
												<div class="col-sm-10">
													<input type="text" class="form-control" placeholder=" Meta Title" id="meta_title" name="meta_title" value="{{ old('meta_title') }}">
											...
											<div class="box-body">
												<div class="form-group{{ $errors->has('meta_description') ? ' has-error' : '' }}">
													...
													<div class="col-sm-10">
														<textarea id="meta_description" name="meta_description" rows="10" cols="113">{{ old('meta_description') }}</textarea>
											...
											<div class="box-body">
												<div class="form-group{{ $errors->has('focus_keywords') ? ' has-error' : '' }}">
													...
													<div class="col-sm-10">
														<textarea id="focus_keywords" name="focus_keywords" rows="10" cols="113">{{ old('focus_keywords') }}</textarea>
